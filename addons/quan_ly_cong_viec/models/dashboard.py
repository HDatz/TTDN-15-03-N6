...
class Dashboard(models.Model):
    ...
    du_an_ids = fields.One2many('du_an', 'id', string='Danh sách dự án')
    ...
    @api.depends('so_luong_nhan_vien', 'so_luong_du_an', 'so_luong_cong_viec', 'du_an_hoan_thanh', 'du_an_dang_thuc_hien', 'du_an_chua_bat_dau','du_an_tam_dung')
    def _compute_tong_quan(self):
        for record in self:
            ...
            record.phan_tram_hoan_thanh = (sum(du_an_records.mapped('phan_tram_du_an')) / len(du_an_records)) if du_an_records else 0.0
